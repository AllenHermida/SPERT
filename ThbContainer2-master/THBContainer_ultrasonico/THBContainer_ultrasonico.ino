...
#define NODE_NAME "SPERT"   //nombre que le pusieron al dispositivo cuando lo crearon
#define NODE_TOKEN "h1GRSO1gZorFEZBZCCxO"   //Token que genera Thingboard para dispositivo cuando lo crearon
